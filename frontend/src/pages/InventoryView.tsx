...
export const InventoryView: React.FC<InventoryViewProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'summary' | 'credentials'>('summary');
  ...
  if (!selectedNode) {
    return (
      <div className="infravault-inventory-split">
        ...
        <div className="inventory-details-pane empty-selection-panel flex-align justify-content-center p-5">
    ...
    <div className="infravault-inventory-split">
      ...
      <div className="inventory-details-pane">
        ...
        <div className="details-pane-body p-4">
          ...
          {selectedNode.type === 'device' && activeTab === 'summary' && (
          ...
          {selectedNode.type === 'device' && activeTab === 'credentials' && (
            <div className="credentials-tab-content">
              ...
              {loadingCreds ? (
                ...
                <div className="credentials-grid">
                  ...
                  {/* Interactive Add Credential Field Card */}
                  <div
